...
urlpatterns = [
    ...
    # path('text_input_bill.html/', tib_views.form_name_view, name='text_input_bill.html'),
    # path('radio_button_bill.html/', rbb_views.form_name_view, name='radio_button_bill.html'),
